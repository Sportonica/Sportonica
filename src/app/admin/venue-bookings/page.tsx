    ...
    <>
      ...
      <div className="adm-body">
        <p style={{ opacity: 0.6, fontSize: 13.5, marginBottom: 20, maxWidth: 560 }}>
          Every tournament proposed at your venue shows up here one at a time, even from an organizer
          you&apos;ve already partnered with. Nothing here is automatic: each one needs your own yes
